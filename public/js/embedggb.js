...
(function () {
  ...
  var GGBApplet = function () {
    ...
    var jnlpFilePath = "";
    var html5Codebase = "//ggb-cdn.sredsol.com/";
    ...
    var injectHTML5Applet = function (appletElem, parameters, noPreview) {
      ...
      if (loadScript) {
        ...
        if (
          ...
          require(["/web3d/web3d.nocache"], scriptLoaded);
        } else {
    ...
    var setDefaultHTML5CodebaseForVersion = function (version, offline) {
      ...
      if (index > 0) {
        ...
        codebase = "https://ggb-cdn.sredsol.com/";
      }
  ...
  GGBAppletUtils.makeModule = function (name, permutation) {
    function webModule() {
      ...
      A();
      webModule.__moduleBase = "/lib/" + name + "/";
